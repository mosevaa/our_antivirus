...
# Form implementation generated from reading ui file '.\ui_templates\quarantineDeleteWin.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Выберите файлы для удаления из карантина:"))
...
class Quarantine_Delete(QtWidgets.QMainWindow):
    def __init__(self):
